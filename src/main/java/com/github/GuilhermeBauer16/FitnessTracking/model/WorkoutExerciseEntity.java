...
public class WorkoutExerciseEntity {
    ...
    public WorkoutExerciseEntity(String id, String name, String description, Integer caloriesBurned, ExerciseType exerciseType,
                                 String equipmentNeeded, DifficultyLevel difficultyLevel, Set<MuscleGroup> muscleGroups) {
        this.id = id;
        this.name = name;
